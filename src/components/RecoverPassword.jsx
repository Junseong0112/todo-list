    ...
    >
      ...
      <span className="block mt-4 rounded-md shadow-sm">
        <button
          ...
          type="button"
          className="flex justify-center px-4 py-2 mx-auto text-sm font-medium text-white transition duration-150 ease-in-out bg-blue-600 border border-transparent rounded-md hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue active:bg-blue-700"
        >
          Change Password
        </button>
      </span>
